...
public class SA_EvaluationTest {
    ...
    void voisinageTest() {
        ...
        evaluation.exportCSV(new File("sa_experience/voisin4.csv"));
        ...
        evaluation.experiment();
        evaluation.exportCSV(new File("sa_experience/voisin8.csv"));
        ...
        evaluation.experiment();
        evaluation.exportCSV(new File("sa_experience/distance.csv"));
    }
}
